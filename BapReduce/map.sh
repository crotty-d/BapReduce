...
# Input
file="$1" # Filepath of file to map
...
# Read through the <filename>_instances file line-by-line and extract its contents into
# a number of key files according to the instance value (key), i.e. one file for each key.
